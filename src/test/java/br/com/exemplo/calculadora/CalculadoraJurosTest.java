...
class CalculadoraJurosTest {
    ...
    class JurosSimplesTest {
        ...
        void deveCalcularJurosSimples() {
            ...
            double resultado = calculadora.jurosSimples(
                    1000,
                    0.10,
                    2
            );
        ...
        void deveTestarVariacoesJurosSimples() {
            ...
            assertAll(
                ...
                () -> assertEquals(
                        100,
                        calculadora.jurosSimples(1000, 0.10, 1),
                        0.01
                ),
                ...
                () -> assertEquals(
                        500,
                        calculadora.jurosSimples(5000, 0.10, 1),
                        0.01
                )
    ...
    class JurosCompostosTest {
        ...
        void deveCalcularJurosCompostos() {
            ...
            double resultado = calculadora.jurosCompostos(
                    1000,
                    0.10,
                    2
            );
